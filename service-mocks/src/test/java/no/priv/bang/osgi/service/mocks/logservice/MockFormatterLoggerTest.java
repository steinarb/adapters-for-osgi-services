...
class MockFormatterLoggerTest {

    @Test
    void testTraceOnLoggerWithName() {
        MockLogService mockLogService = new MockLogService();
        String name = "TestLogger";
        FormatterLogger logger = mockLogService.getLogger(name, FormatterLogger.class);
        ...
        logger.trace("Message 2 %d", Integer.valueOf(123));
        ...
        logger.trace("Message 3 %d %d", Integer.valueOf(123), Integer.valueOf(456));
        ...
        logger.trace("Message 4 %d %d %d", Integer.valueOf(123), Integer.valueOf(456), Integer.valueOf(789));
    ...
    void testDebugOnLoggerWithName() {
        ...
        assertThat(logCount1).isPositive();
        assertEquals("[DEBUG] " + message1, mockLogService.getLogmessages().get(logCount1 - 1));
        logger.debug("Message 2 %d", Integer.valueOf(123));
        int logCount2 = mockLogService.getLogmessages().size();
        assertThat(logCount2).isGreaterThan(logCount1);
        assertEquals("[DEBUG] Message 2 123", mockLogService.getLogmessages().get(logCount2 - 1));
        logger.debug("Message 3 %d %d", Integer.valueOf(123), Integer.valueOf(456));
        int logCount3 = mockLogService.getLogmessages().size();
        assertThat(logCount3).isGreaterThan(logCount2);
        assertEquals("[DEBUG] Message 3 123 456", mockLogService.getLogmessages().get(logCount3 - 1));
        logger.debug("Message 4 %d %d %d", Integer.valueOf(123), Integer.valueOf(456), Integer.valueOf(789));
        int logCount4 = mockLogService.getLogmessages().size();
        assertThat(logCount4).isGreaterThan(logCount3);
        assertEquals("[DEBUG] Message 4 123 456 789", mockLogService.getLogmessages().get(logCount4 - 1));
        ...
        int logCount5 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount5);
        logger.debug("Message 6 %d", 123);
        int logCount6 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount6);
        logger.debug("Message 7 %d %d", 123, 456);
        int logCount7 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount7);
        logger.debug("Message 8 %d %d %d", 123, 456, 789);
        int logCount8 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount8);
    }
    ...
    void testInfoOnLoggerWithName() {
        ...
        logger.info("Message 2 %d", Integer.valueOf(123));
        int logCount2 = mockLogService.getLogmessages().size();
        assertThat(logCount2).isGreaterThan(logCount1);
        assertEquals("[INFO] Message 2 123", mockLogService.getLogmessages().get(logCount2 - 1));
        logger.info("Message 3 %d %d", Integer.valueOf(123), Integer.valueOf(456));
        int logCount3 = mockLogService.getLogmessages().size();
        assertThat(logCount3).isGreaterThan(logCount2);
        assertEquals("[INFO] Message 3 123 456", mockLogService.getLogmessages().get(logCount3 - 1));
        logger.info("Message 4 %d %d %d", Integer.valueOf(123), Integer.valueOf(456), Integer.valueOf(789));
        int logCount4 = mockLogService.getLogmessages().size();
        assertThat(logCount4).isGreaterThan(logCount3);
        ...
        int logCount5 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount5);
        logger.info("Message 6 %d", 123);
        int logCount6 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount6);
        logger.info("Message 7 %d %d", 123, 456);
        int logCount7 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount7);
        logger.info("Message 8 %d %d %d", 123, 456, 789);
        int logCount8 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount8);
    }
    ...
    void testWarningOnLoggerWithName() {
        ...
        logger.warn("Message 2 %d", Integer.valueOf(123));
        int logCount2 = mockLogService.getLogmessages().size();
        assertThat(logCount2).isGreaterThan(logCount1);
        assertEquals("[WARNING] Message 2 123", mockLogService.getLogmessages().get(logCount2 - 1));
        logger.warn("Message 3 %d %d", Integer.valueOf(123), Integer.valueOf(456));
        int logCount3 = mockLogService.getLogmessages().size();
        assertThat(logCount3).isGreaterThan(logCount2);
        assertEquals("[WARNING] Message 3 123 456", mockLogService.getLogmessages().get(logCount3 - 1));
        logger.warn("Message 4 %d %d %d", Integer.valueOf(123), Integer.valueOf(456), Integer.valueOf(789));
        int logCount4 = mockLogService.getLogmessages().size();
        assertThat(logCount4).isGreaterThan(logCount3);
        ...
        int logCount5 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount5);
        logger.warn("Message 6 %d", 123);
        int logCount6 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount6);
        logger.warn("Message 7 %d %d", 123, 456);
        int logCount7 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount7);
        logger.warn("Message 8 %d %d %d", 123, 456, 789);
        int logCount8 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount8);
    }
    ...
    void testErrorOnLoggerWithName() {
        ...
        logger.error("Message 2 %d", Integer.valueOf(123));
        int logCount2 = mockLogService.getLogmessages().size();
        assertThat(logCount2).isGreaterThan(logCount1);
        assertEquals("[ERROR] Message 2 123", mockLogService.getLogmessages().get(logCount2 - 1));
        logger.error("Message 3 %d %d", Integer.valueOf(123), Integer.valueOf(456));
        int logCount3 = mockLogService.getLogmessages().size();
        assertThat(logCount3).isGreaterThan(logCount2);
        assertEquals("[ERROR] Message 3 123 456", mockLogService.getLogmessages().get(logCount3 - 1));
        logger.error("Message 4 %d %d %d", Integer.valueOf(123), Integer.valueOf(456), Integer.valueOf(789));
        int logCount4 = mockLogService.getLogmessages().size();
        assertThat(logCount4).isGreaterThan(logCount3);
        ...
        int logCount5 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount5);
        logger.error("Message 6 %d", 123);
        int logCount6 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount6);
        logger.error("Message 7 %d %d", 123, 456);
        int logCount7 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount7);
        logger.error("Message 8 %d %d %d", 123, 456, 789);
        int logCount8 = mockLogService.getLogmessages().size();
        assertEquals(logCount4, logCount8);
    }
    ...
    void testAuditOnLoggerWithName() {
        ...
        assertThat(logCount1).isPositive();
        assertEquals("[ERROR] " + message1, mockLogService.getLogmessages().get(logCount1 - 1));
        logger.audit("Message 2 %d", Integer.valueOf(123));
        int logCount2 = mockLogService.getLogmessages().size();
        assertThat(logCount2).isGreaterThan(logCount1);
        assertEquals("[ERROR] Message 2 123", mockLogService.getLogmessages().get(logCount2 - 1));
        logger.audit("Message 3 %d %d", Integer.valueOf(123), Integer.valueOf(456));
        int logCount3 = mockLogService.getLogmessages().size();
        assertThat(logCount3).isGreaterThan(logCount2);
        assertEquals("[ERROR] Message 3 123 456", mockLogService.getLogmessages().get(logCount3 - 1));
        logger.audit("Message 4 %d %d %d", Integer.valueOf(123), Integer.valueOf(456), Integer.valueOf(789));
        int logCount4 = mockLogService.getLogmessages().size();
        assertThat(logCount4).isGreaterThan(logCount3);
        assertEquals("[ERROR] Message 4 123 456 789", mockLogService.getLogmessages().get(logCount4 - 1));
    }
    ...
    void testLoggerWithClass() {
        MockLogService mockLogService = new MockLogService();
        FormatterLogger logger = mockLogService.getLogger(MockFormatterLoggerTest.class, FormatterLogger.class);
        assertEquals(MockFormatterLoggerTest.class.getCanonicalName(), logger.getName());
    }

    @Test
    void testLoggerWithBundleAndName() {
        MockLogService mockLogService = new MockLogService();
        Bundle bundle = mock(Bundle.class);
        String name = "Testloggers";
        FormatterLogger logger = mockLogService.getLogger(bundle, name, FormatterLogger.class);
        assertEquals(name, logger.getName());
    }
